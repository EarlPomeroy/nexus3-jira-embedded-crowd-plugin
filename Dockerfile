...
RUN curl -L https://github.com/EarlPomeroy/nexus3-jira-embedded-crowd-plugin/releases/download/3.25.1/nexus3-jira-crowd-plugin-3.25.1.jar --output /opt/sonatype/nexus/system/nexus3-jira-crowd-plugin.jar
